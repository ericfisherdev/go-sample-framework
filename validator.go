...
func (f *FinishLine) Validator(data url.Values) *Validation {
	return &Validation{
...
func (v *Validation) IsInt(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must be a number (int)")
	}
}
...
func (v *Validation) IsFloat(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must be a number (f64)")
	}
}
