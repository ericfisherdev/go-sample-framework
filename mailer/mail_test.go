...
func TestMail_SendUsingChan(t *testing.T) {
	...
	res = <-mailer.Results
	if res.Error == nil {
		t.Error(errors.New("failed to error on invalid email address"))
	}
}
...
func TestMail_SendUsingAPI(t *testing.T) {
	...
	if err == nil {
		t.Error(errors.New("failed to error on invalid api values"))
	}
...
func TestMail_Send(t *testing.T) {
	...
	err = mailer.Send(msg)
	if err == nil {
		t.Error(errors.New("send() failed to error on invalid api values"))
	}
}
...
func TestMail_ChooseAPI(t *testing.T) {
	...
	if err == nil {
		t.Error(errors.New("ChooseAPI() failed to error on invalid api values"))
	}
}
