...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		upFile := fin.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := fin.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := fin.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "model":
		...
		fileName := fin.RootPath + "/data/" + strings.ToLower(modelName) + ".go"
	...
	case "mail":
		...
		htmlMail := fin.RootPath + "/mail/" + strings.ToLower(arg3) + ".html.tmpl"
		plainMail := fin.RootPath + "/mail/" + strings.ToLower(arg3) + ".plain.tmpl"
